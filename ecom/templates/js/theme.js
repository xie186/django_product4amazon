    ...
    Instagram.prototype = $.extend({}, Instagram.prototype, {
      ...
      init: function() {
        ...
        var feed = this.feed = new Instafeed({
          ...
          userId: userId,
          limit: count + 2,
          template: '<div class="grid__item '+ gridItemWidth +'"><div class="image-wrap"><a href="" target="_blank" style="background-image: url(); display: block; padding-bottom: 100%; background-size: cover; background-position: center;"></a></div></div>',
